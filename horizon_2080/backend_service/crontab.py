    ...
    for item in remind_list:
        for user in user_list:
            if(user.name == item["target_user"]):
                ...
                This is a reminder email that a target is behind schedule
                </td>
                </tr>
                </table>
                </td>
                ...
                <a style="text-decoration:none" href="http://localhost:8000/performance/project/{id}"><h1 style="color:rgb(62,116,173)">{target_name}</h1></a>
                <h3>{reminder}</h3>
                Please take notice, this target is behind schedule and needs your attention
                <br />
                </td>
                </tr>
                </table>
                ...
                <tr>
                <td valign="top" class="footerContent" mc:edit="footer_content00" style="float:right">
                <a style="text-decoration:none;color:#3e74ad" href="http://horizon2080.chinacloudsites.cn"><b>Horizon 2080</b></a>
                <em>Copyright &copy; 2019 JLL, All rights reserved.</em>
                </td>
                </tr>
                </table>
                </td>
