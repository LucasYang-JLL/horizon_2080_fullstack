...
def my_scheduled_job():
    ...
    # list of all user email to write Monthly Goal to
    for user in user_list:
        ...
        """ + """<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0"> <center> <table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="bodyTable"> <tr> <td align="center" valign="top" id="bodyCell"> <table border="0" cellpadding="0" cellspacing="0" id="templateContainer"> <tr> <td align="center" valign="top"> <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templatePreheader"> <tr> <td valign="top" class="preheaderContent" style="padding-top:10px;padding-right:20px;padding-bottom:10px;padding-left:20px" mc:edit="preheader_content00"> This is an auto-generated email. No-Reply </td></tr></table> </td></tr><tr> <td align="center" valign="top"> <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody"> <tr> <td valign="top" class="bodyContent" mc:edit="body_content"> <a style="text-decoration:none" href="https://horizon2080.chinacloudsites.cn/monthly-goal"><h1 style="color:rgb(62,116,173)">Monthly Goal</h1></a> The Monthly Goal shows the targets that are behind schedule <br/> </td></tr></table> </td></tr><tr> <td align="center" valign="top"> <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter"> <tr> <td valign="top" class="footerContent" mc:edit="footer_content00" style="float:right"> <a style="text-decoration:none;color:#3e74ad" href="https://horizon2080.chinacloudsites.cn"><b>Horizon 2080</b></a> <em>Copyright &copy; 2019 JLL, All rights reserved.</em> </td></tr></table> </td></tr></table> </td></tr></table> </center> </body> </html>"""
        send_mail(
            "[Horizon 2080] Monthly Goal",
            "Horizon 2080 Email",
...
def target_urgency():
    ...
    for target in target_list:
        total_duration = (target['expire_date'] - target['start_date']).total_seconds()
        if (total_duration > 0):
            upTillNow = (datetime.date.today() - target['start_date']).total_seconds()
            timeLapse = upTillNow / total_duration # time spent 
            progress = target['progress']/100 # progress
